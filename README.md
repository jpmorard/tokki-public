...
/path/to/tokki-1.0.35-py3-none-macosx_11_0_arm64.whl
...
```sh
python3 -m pip install --user --upgrade --force-reinstall \
/path/to/tokki-1.0.35-py3-none-manylinux_2_35_x86_64.whl
...
C:\Path\To\tokki-1.0.35-py3-none-win_amd64.whl
tokki --version
```
...
Current public package: `tokki 1.0.35`.

`1.0.35` provides private wheelhouse artifacts for:

- macOS arm64: `tokki-1.0.35-py3-none-macosx_11_0_arm64.whl`
- Linux x86_64: `tokki-1.0.35-py3-none-manylinux_2_35_x86_64.whl`
- Windows x86_64: `tokki-1.0.35-py3-none-win_amd64.whl`
