...
## Current release: 1.0.57

- [Manifest](releases/1.0.57/release-artifacts.json)
- [Signature](releases/1.0.57/release-artifacts.sig)
- [SHA-256 sums](releases/1.0.57/SHA256SUMS)
- [SPDX dependency inventory](releases/1.0.57/SBOM.spdx.json)
...
```sh
tokki release verify-artifacts /path/to/tokki-1.0.57 --json
```
...
The `1.0.57` SPDX document is a source dependency inventory generated from the
