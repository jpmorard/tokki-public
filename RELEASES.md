...
- [Manifest](releases/1.0.54/release-artifacts.json)
- [Signature](releases/1.0.54/release-artifacts.sig)
- [SHA-256 sums](releases/1.0.54/SHA256SUMS)
- [SPDX dependency inventory](releases/1.0.54/SBOM.spdx.json)
...
The `1.0.54` SPDX document is a source dependency inventory generated from the
